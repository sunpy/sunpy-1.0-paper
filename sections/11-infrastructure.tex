...
All documentation for \sunpypkg, as well as all affiliated packages, is uses the commonly-used \code{Sphinx} documentation build system\footnote{\url{http://www.sphinx-doc.org/en/master/}}.
