...
The \Timeseries class aims to accommodate the necessary requirements to represent such solar time series data.
...
\begin{figure}
    ...
    \caption{An example of a GOES X-ray Sensor \Timeseries plotted over a 24 hour period. The two colors represent the two broadband channels of GOES 1--8~\AA\ (red) and 0.5--4~\AA\ (blue).  The sharp increase in flux is a solar flare and the grey dashed line denotes the time of the flare peak as determined by the HEK.}
