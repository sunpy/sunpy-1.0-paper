...
The \package{sunpy.physics.differential\_rotation} subpackage provides the ability for a \Map to be transformed to a to a future time with compensation for solar differential rotation (see \autoref{fig:diff_rot}).
