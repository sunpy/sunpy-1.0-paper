...
The \package{astropy.time} subpackage provides the necessary support non-UTC time scales used in some solar data sets such as International Atomic Time (TAI), and also provides functionality for representing time formats used in solar physics such as Julian day and Unix time. 
It also provides support for creating custom time scales and formats. 
