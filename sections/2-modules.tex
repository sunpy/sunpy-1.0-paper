...
The \code{CompositeMap} class permits the simple overlay and plot multiple \Map classes; such functionality is useful in displaying data from instruments with overlapping fields of view.
