...
The \package{drms} package provides access to query the rich image metadata in the JSOC DRMS.
This package can also be used to submit tailored data export requests (e.g. movies and images in various formats) and download data files and is built on the HTTP/JSON interface provided by JSOC.
...
This package provides data classes that hold data from SJI and SG respectively.
